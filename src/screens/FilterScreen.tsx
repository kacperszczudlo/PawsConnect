...
const styles = StyleSheet.create({
  ...
  inputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8fafc', borderRadius: 12, paddingHorizontal: 15, height: 50, marginBottom: 20 },
  ...
  footer: { padding: 20, flexDirection: 'row', gap: 15, borderTopWidth: 1, borderTopColor: '#f1f5f9' },
